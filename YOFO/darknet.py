...
def get_test_input():
    img = cv2.imread("YOFO\\dog-cycle-car.png")
...
def create_modules(blocks):
    ...
    for index, x in enumerate(blocks[1:]):
        ...
        if (x["type"] == "convolutional"):
            ...
            conv = nn.Conv2d(prev_filters, filters, kernel_size, stride, pad, bias = bias) #changed bias with dilation
...
model = Darknet("YOFO\\yofov3.cfg")
model.load_weights("YOFO\\yolov3.weights")
inp = get_test_input()
